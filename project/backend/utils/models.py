...
class MLP(nn.Module):
    ...
    def fit(self, train_loader=train_loader, test_loader=test_loader, epochs=50, learning_rate=0.001):
...
class CNN(nn.Module):
    ...
    def fit(self, train_loader=train_loader, test_loader=test_loader, epochs=50, learning_rate=0.001, patience=5):
        self.total_epochs = epochs
        loss_function = nn.CrossEntropyLoss()
        ...
        for epoch in range(epochs):
            ...
            if val_loss < best_val_loss:
                ...
                if patience_counter >= patience:
                    logger.info(f"Early stopping at epoch {epoch+1}/{epochs}")
                    break
    ...
    def predict(self, X):
        ...
        with torch.no_grad():
            ...
            if (X.dim() == 3):
                ...
                raise ValueError("Expected single-channel (grayscale) images.")
